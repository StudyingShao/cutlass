...
void profile_pp_2x2x1(Options& options, std::vector<MixedDtypeResult>& results, std::vector<std::string>& configs) {
    ...
    const std::string PX = "   KernelPtrArrayTmaWarpSpecializedPingpong Shape<_2,_2,_1>";
