...
void profile_pp_1x2x1(Options& options, std::vector<MixedDtypeResult>& results, std::vector<std::string>& configs) {
    ...
    const std::string PX = "   KernelPtrArrayTmaWarpSpecializedPingpong Shape<_1,_2,_1>";
