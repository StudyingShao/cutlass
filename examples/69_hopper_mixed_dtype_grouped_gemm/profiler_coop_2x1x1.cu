...
void profile_coop_2x1x1(Options& options, std::vector<MixedDtypeResult>& results, std::vector<std::string>& configs) {
    ...
    const std::string PX = "KernelPtrArrayTmaWarpSpecializedCooperative Shape<_2,_1,_1>";
