...
void profile_coop_1x1x1(Options& options, std::vector<MixedDtypeResult>& results, std::vector<std::string>& configs) {
    ...
    const std::string PX = "KernelPtrArrayTmaWarpSpecializedCooperative Shape<_1,_1,_1>";
